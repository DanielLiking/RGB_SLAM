#ifndef PROCESSING_CLASS_H_
#define PROCESSING_CLASS_H_
#include <ros/ros.h>
//pcl lib 
...
class ProcessingClass{
    public:
        ...
        pcl::PointCloud<pcl::PointXYZRGBL>::Ptr& pc_out_line, pcl::PointCloud<pcl::PointXYZRGB>::Ptr& cloud_filter);
